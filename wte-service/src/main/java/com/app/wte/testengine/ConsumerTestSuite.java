...
public class ConsumerTestSuite extends TestSuite {
	...
	public void executeTest(TestResult testResult) {
		...
		if(testResult.getTaskSatusMap()!= null){
			logger.info("ConsumerTestSuite getTaskSatusMap FileGenerationTask: "+testResult.getTaskSatusMap().get("FileGenerationTask"));
			logger.info("ConsumerTestSuite getTaskSatusMap FTPTransferTask: "+testResult.getTaskSatusMap().get("FTPTransferTask"));
		}
	}
