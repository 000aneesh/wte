...
public class TestRunController {
	...
	public void testCaseRun(@RequestParam("testCase") String testCase, @RequestParam("fileName") String fileName,
	...
	public ExecutionStatusType getResult(@RequestParam("testCase") String testCase,
			@RequestParam("executionStep") String executionStep) {
		...
		System.out.println("getResult method TestCase name: " + executionContext.getTestCase() + "getFileName: "
				+ executionContext.getFileName());
		return executionStatusType;
	}

	@RequestMapping(value = "/getResultDetails")
	public ProcessValidationResult getResultDetails(@RequestParam("testCase") String testCase,
			@RequestParam("executionStep") String executionStep) {
		System.out.println("Entered getResult method: ");
		// ExecutionContext executionContext=testEngine.getTestResult("TestCase01");
