...
public class TestEngine {
	...
	public void startTestSuite(TestResult testResult){
	    ...
	    if(myThread.getTestResult() != null){
			logger.info("TestEngine getTaskSatusMap FileGenerationTask: "+myThread.getTestResult().getTaskSatusMap().get("FileGenerationTask"));
			logger.info("TestEngine getTaskSatusMap FTPTransferTask: "+myThread.getTestResult().getTaskSatusMap().get("FTPTransferTask"));
		}
